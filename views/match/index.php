                ...
                'value' => function($model, $index, $dataColumn) {
                        ...
                        if ($bet)
                            ...
                            ( $model->canBet() ?
                                ...
                                Html::a("<span class='glyphicon glyphicon-trash'></span>", ['bet/delete', 'id' => $bet->id], ['data' => ['confirm' => 'Are you sure you want to delete this bet?', 'method'=>'post']])
                                : '' );
                        elseif ($model->canBet())
            ...
            [
                ...
                'buttons' => [
                    'history' => function ($url, $model) {
                            return Html::a('<span class="glyphicon glyphicon-list"></span>', array('/bet/view', 'match_id' => $model->id), [
